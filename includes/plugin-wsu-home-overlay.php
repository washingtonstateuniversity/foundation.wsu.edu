...
class WSU_Home_Overlay {
	...
	public function enqueue_styles() {
		if ( 'takeover' === $this->overlay_type() ) {
			wp_enqueue_style( 'wsu-overlay-style', get_stylesheet_directory_uri() . '/includes/css/overlay.css', array(), spine_get_script_version() );
		}
	}
	...
	public function enqueue_scripts() {
		if ( 'takeover' === $this->overlay_type() ) {
			wp_enqueue_script( 'wsu-overlay-script', get_stylesheet_directory_uri() . '/includes/js/overlay.js', array( 'jquery' ), spine_get_script_version(), true );
		}
	}
}
